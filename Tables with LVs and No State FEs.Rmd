---
title: "Replication - Lagged Variables Without State Fixed Effects"
...
# Table 1 with Lagged Variables and No State Fixed Effects
```{r, include = F}
# subset for Lag Table 1, Without State FEs
df_tab1 <- df %>%
...
```{r, results = "asis"}
# print Lagged Table 1 Without State FEs
...
# Table 2 with Lagged Variables and No State Fixed Effects
```{r}
# subset for overall Lag Table 2, Without State FEs
df_lag4 <- df %>%
...
```{r, results = "asis"}
# print Lagged Table 2, Without State FEs
